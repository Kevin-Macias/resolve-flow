...
quality baseline. The next ticket is RF-101: model the issue-report domain in
typed Python before persistence is designed.
...
| ID | Ticket | Owner | Status | Acceptance |
| --- | --- | --- | --- | --- |
| RF-101 | Model the issue-report domain in Python | HAND | NEXT | Typed customer/account references, report lifecycle, service, create, update, and response models validate correctly |
| RF-102 | Implement application factory and health API | HAND | PLANNED | Factory-based app exposes tested health/readiness behavior; existing global app is refactored as needed |
